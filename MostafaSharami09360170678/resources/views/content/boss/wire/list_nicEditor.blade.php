            ...
            <form action="{{ url('wire') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3" style="border-bottom: solid 1px #000;">
                    ...
                    <div class="col-md-6 col-sm-12 form-group">
                        ...
                        <textarea name="des" id="des" rows="4" style="width: 100%;" class="form-control"></textarea>
                    </div>
                </div>
...
@section('js')
    <script type="text/javascript" src="/static/js/nicEdit-fa.js"></script>
    <script type="text/javascript">
        ...
        bkLib.onDomLoaded(function() {
            new nicEditor({buttonList: ['bold', 'italic', 'underline', 'strikethrough', 'left', 'center', 'right', 'justify', 'ol', 'ul', 'subscript', 'superscript', 'indent', 'outdent', 'hr', 'forecolor', 'bgcolor', 'link', 'unlink', 'fontFamily', 'fontFormat', 'fontSize', 'removeformat']}).panelInstance('des');
        });
    </script>
@endsection
