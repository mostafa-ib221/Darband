...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                <label for="password-confirm" class="col-md-4 col-form-label text-md-left">Password Confirmation</label>
    ...
    {{--<div class="card mb-4 mt-3">
        <div class="card-header"><i class="fas fa-users ml-1"></i> مدیران سایت</div>
        <div class="card-body">
            <div class="row">
              @foreach($admins as $admin)
                <div class="col-md-3 col-sm-6 col-sx-12">
                    <div class="card text-white mb-4">
                        ...
                        <div class="card-footer d-flex align-items-center justify-content-between english">
                            {{ $admin->email }}
                        </div>
                    </div>
                </div>
